...
void main() {
  ...
  group('tests for DefaultApi', () {
    ...
    //Future<Garden> gardensPost({ GardenCreate gardenCreate }) async
    test('test gardensPost', () async {
      // TODO
    });

    //Future<Plant> plantsIdGet(String id) async
    test('test plantsIdGet', () async {
      // TODO
    });

    //Future<Plant> plantsIdPut(String id, { PlantCreate plantCreate }) async
    test('test plantsIdPut', () async {
      // TODO
    });
  });
}
