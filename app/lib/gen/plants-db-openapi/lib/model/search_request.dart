...
class SearchRequest {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is SearchRequest && other.name == name;
  ...
  @override
  String toString() => 'SearchRequest[name=$name]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "SearchRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "SearchRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SearchRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<SearchRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = SearchRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
